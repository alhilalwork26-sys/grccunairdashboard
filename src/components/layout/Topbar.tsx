...
import { Search, Camera, Loader2, Check, X } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 13, color: "#9ca3af", flex: 1, textAlign: "left" }}>Cari...</span>
          <kbd style={{ fontSize: 9, color: "#d1d5db", background: "#f3f4f6", border: "1px solid #e5e7eb", borderRadius: 4, padding: "1px 5px", whiteSpace: "nowrap" }}>
            ⌘K
          </kbd>
        </motion.button>
            ...
            {avatarMenu && (
              <motion.div
                ...
                style={{
                  ...
                  borderRadius: 14, boxShadow: "0 12px 36px rgba(0,0,0,0.13)",
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 11, color: "#9ca3af" }}>Foto Profil</p>
                  </div>
                </div>
